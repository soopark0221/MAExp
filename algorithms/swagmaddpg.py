...
class SWAGMADDPG(object):
    ...
    def __init__(self, agent_init_params, alg_types,
        ...
        self.agents = [SWAGDDPGAgent(lr=lr, discrete_action=discrete_action,
    ...
    @property
    def swags(self):
        return [a.swag_network for a in self.agents]

    @property
    def policies_sample(self):
        return [a.policy_sample for a in self.agents]
    ...
    def prep_rollouts(self, device='cpu'):
        ...
        if not self.pol_dev == device:
            for a in self.agents:
                a.policy = fn(a.policy)
                a.policy_sample = fn(a.policy_sample)
            self.pol_dev = device
